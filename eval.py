...
def vis_quality_evaluate(model_path, scene_path):
    full_dict = {}
    per_view_dict = {}
...
if __name__ == "__main__":
    ...
    output_root = args.output_path[0]
    scene = os.path.join(output_root, "point_cloud/iteration_40000/point_cloud.ply")
    if not os.path.exists(scene):
        print(f"Scene address {scene} not found!")
        exit()

    vis_quality_evaluate(args.model_path[0], scene)
